...
import 'suggestions3.dart';

void main() {
  runApp(MaterialApp(
    home: StatsIneligible3(),
  ));
}

class StatsIneligible3 extends StatelessWidget {
  @override
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      'Lenders prefer a DTI ratio of at most 36%, max allowed is 43%. DTI is the percentage of gross monthly income which goes towards monthly debt payments.',
                      style: TextStyle(
                        fontSize: 28.0,
                        fontFamily: 'Asap',
                        color: Color(0xFF005A92),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Suggestions3()),
                        );
                      },
