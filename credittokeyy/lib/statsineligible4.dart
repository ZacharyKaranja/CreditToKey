...
import 'suggestions4.dart';

void main() {
  runApp(MaterialApp(
    home: StatsIneligible4(),
  ));
}

class StatsIneligible4 extends StatelessWidget {
  @override
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Text(
                      'FEDTI needs to be less than or equal to 28%. It is the ratio of total monthly debt from housing expenses divided by gross monthly income.',
                      style: TextStyle(
                        fontSize: 28.0,
                        fontFamily: 'Asap',
                        color: Color(0xFF005A92),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Suggestions4()),
                        );
                      },
